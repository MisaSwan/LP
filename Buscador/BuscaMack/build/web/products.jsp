    ...
    <body >
        <div data-role="page" id="products" data-theme="b">
            <div data-role="panel" id="mypanel" data-display="push">
                <form  method="GET"  id="searchCategories" action="/ECommerce/FrontController" data-ajax="false"> 
                <ul data-role="listview">
                        ...
                        <li><a href="#" onclick="$(this).append('<input type=\'hidden\' name=\'category\' value=\'<%=product%>\'/>');$('form#searchCategories').trigger('submit');"><%=product%></a></li>  
                        <%}%>
                        <%}%>
